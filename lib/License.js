...
module.exports = class License
{
  ...
  updateSerial ()
  {
    ...
    this.serial = createSerial(this.id, this._validity)
  }
 ...
 */
const createSerial = (id, validity) =>
{
  return generateSerial(id, validity)
}
 ...
 */
const generateSerial = (id, validity) =>
{
  if (!validity) {
    throw errors('VALIDITY_MISSING')
  }
  ...
  return chunkString(regKey, 4, validity)
}
 ...
 */
const chunkString = (str, length, validity) =>
{
  ...
  newStr[2] = validityStr[2] + validityStr[6] + newStr[2]

  newStr[3] = newStr[3] + validityStr[3] + validityStr[7]
